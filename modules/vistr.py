...
class VisTR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        print(src.shape, mask.shape, pos.shape)
        ...
        print(src_proj.shape, mask.shape, pos.shape)
...
if __name__ == '__main__':
    model = bulid().cuda()
    x = torch.randn([36, 3, 224, 224]).cuda()
    mask = torch.ones([36, 224, 224]).cuda()
    nt = NestedTensor(x, mask)
    y = model(nt)
    print(y['pred_logits'].shape, y['pred_boxes'].shape)
